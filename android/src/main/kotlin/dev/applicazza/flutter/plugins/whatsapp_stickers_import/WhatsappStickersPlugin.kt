...
import dev.applicazza.flutter.plugins.whatsapp_stickers_import.InvalidPackException
import dev.applicazza.flutter.plugins.whatsapp_stickers_import.WhitelistCheck
...
public class WhatsappStickersPlugin: FlutterPlugin, MethodCallHandler, ActivityAware, PluginRegistry.ActivityResultListener {
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "whatsapp_stickers_import")
      ...
      "sendToWhatsApp" -> {
        try{
          ...
          if (WhitelistCheck.isWhitelisted(context!!, stickerPackIdentifier)) {
            throw InvalidPackException(InvalidPackException.OTHER, "Sticker pack already added")
          }
