...
public class StickerPack implements Parcelable {
    ...
    public StickerPack(String identifier, String name, String publisher, List<Uri> stickerUris, Context context) {
        this.identifier = identifier;
        this.name = name;
        this.publisher = publisher;
        ...
        for (Uri uri : stickerUris) {
            addSticker(uri, context);
        }
    }

    public StickerPack(String identifier, String name, String publisher, String trayImageFileName, String publisherEmail, String publisherWebsite, String privacyPolicyWebsite, String licenseAgreementWebsite, List<Uri> stickerUris, Context context) {
        this.identifier = identifier;
        this.name = name;
        this.publisher = publisher;
        this.trayImageFile = trayImageFileName;
        this.trayImageUri = ImageManipulation.convertIconTrayToWebP(stickerUris.get(0), this.identifier, "trayImage", context);
        this.publisherEmail = publisherEmail;
        this.publisherWebsite = publisherWebsite;
        this.privacyPolicyWebsite = privacyPolicyWebsite;
